...
function ExibirMensagem(classe) {
  ...
  if (classe == "msg--enviar") {
    msg.innerHTML = "Carga con exito";
  } else {
    msg.innerHTML = "Existen campos en blanco";
  }
...
window.onload = function () {
  ...
  const preco = document.getElementById('precio');
  const descricao = document.getElementById('descripcion');
