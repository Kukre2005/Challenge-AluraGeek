...
export function nav(paths) {
  ...
  <div class="navHeader__left">
    ...
    <div class="navHeader__search">
      <input type="text" class="navHeader__search--input" placeholder="¿Que desea Buscar?"/>
...
export function footer(paths) {
  ...
  <section class="footer">
    <div class="container">
      ...
      <div class="footer__text">
        ...
        <a href="#">Quiero ser una franquicia</a href="">
  ...
  <p>Desarrollado por &copy Maximiliano Rios</p>
  </div>
  `;
